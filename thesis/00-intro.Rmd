...
With the advent of affordable sequencing technologies, microbiology has undergone an information revolution including the expansion of the tree of life by sequencing of uncultivatable bacteria [@brown2015unusual; @parks2017recovery], the discovery of prokaryotic immune systems [@mojica2005intervening], and the discovery of prokaryotic genome fluidity [@tettelin2005genome; @andreani2017prokaryote].
These revolutionary discoveries were enabled not only with next generation sequencing technologies, but also by increasingly complex sequencing analysis methods. 
...
It was the first time a DNA fragment of that size had been sequenced from a mixed microbial community, and these efforts along with other gave rise to the eventual field of shotgun metagenomics [@handelsman1998molecular].
...
As sequencing technology, computational infrastructure, and computational methods have matured, thousands of metagenomes containing hundreds of thousands of species have been generated from diverse ecosystems [@sunagawa2015structure; @kopf2015ocean; @lloyd2017strains; @parks2017recovery; @lloyd2019multi].
<!-- In the same print space allocated to a sequence in H. XXXX highlighting repeats that would later be discovered as CRISPRs, a tree of an entire proposed and previously unobserved bacterial phyla species was instead represented. -->
...
Methods are advancing toward enabling strain-resolved metagenomics [@quince2017desman; @quince2020metagenomics], but no method enables complete strain deconvultion from metagenomes. 
...
The second dataset is a meta-cohort comprising six human gut microbiome shotgun metagenomes during inflammatory bowel disease (n = 605 samples).
