...
```{=latex}
\begin{epigraphs}
  \qitem{Automation is good, so long as you know exactly where to put the machine.” - Eliyahu Goldratt}%
        {Eliyahu Goldratt}
\end{epigraphs}
```
...
Rowe 2019 [@cHw8gtst] reviewed programs and genomic use cases for sketching algorithms, and provided a series of tutorial workbooks (e.g. Sample QC notebook: [@1BD5D1yRX]).
